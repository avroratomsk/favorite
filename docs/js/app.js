(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                ...
                if (!menu.classList.contains("menu-open")) menuOpen(); else menuClose();
            }
        }));
    }
    function menuOpen() {
    ...
    function initSliders() {
        if (document.querySelector(".single-banner__slider")) new swiper_core_Swiper(".single-banner__slider", {
        ...
        if (document.querySelector(".utp__slider")) new swiper_core_Swiper(".utp__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    if (readReviewsBtn.length > 0) readReviewsBtn.forEach((btn => {
